...
class LinuxHardware(Hardware):
    ...
    def get_device_facts(self):
        ...
        for block in block_devs:
            ...
            discard_granularity = get_file_content(sysdir + '/queue/discard_granularity')
            discard_max_hw_bytes = get_file_content(sysdir + '/queue/discard_max_hw_bytes')
            d['support_discard'] = '0' if discard_granularity == '0' or discard_max_hw_bytes == '0' else discard_granularity
